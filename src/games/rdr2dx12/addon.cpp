...
// Unofficial, INACTIVE experimental DX12 scaffold derived from the Vulkan addon.
// Upstream attribution is retained; Musa Haji does not maintain this DX12 fork.
#define ImTextureID ImU64

#define DEBUG_LEVEL_1

// Do not include embed/shaders.h yet: a build with no shaders may not generate it.
// Once verified DX12 replacement shaders exist, add that include and register
// their actual hashes and generated bytecode in custom_shaders below.
...
// Intentionally empty: no DX12 hashes have been verified and no replacements
// are registered. Do not reuse Vulkan hashes or add placeholder hashes.
// When enabling verified DX12 tonemap replacements later, attach
// OnTonemapShaderDrawn to their on_drawn callbacks so OnPresent can reset state.
...
renodx::utils::settings::Settings settings = {
    ...
    new renodx::utils::settings::Setting{
        .value_type = renodx::utils::settings::SettingValueType::TEXT,
        .label = std::string("- Unofficial, INACTIVE experimental DX12 scaffold for Red Dead Redemption 2.\n"
                             "- No shader replacements registered; settings do not enable HDR/tone mapping.\n"
                             "- Derived from Musa Haji's Vulkan addon; Musa does not maintain this fork.\n"
                             "- Upstream links are retained for attribution, not DX12 fork support."),
        .section = "About",
    },
};
...
extern "C" __declspec(dllexport) constexpr const char* NAME = "RenoDX RDR2 - Unofficial INACTIVE DX12 Scaffold";
extern "C" __declspec(dllexport) constexpr const char* DESCRIPTION = "Unofficial, inactive experimental DX12 scaffold for Red Dead Redemption 2; no shader replacements; not maintained by Musa Haji.";
  ...
  switch (fdw_reason) {
    case DLL_PROCESS_ATTACH:
      ...
      reshade::log::message(
          ...
          "RenoDX RDR2: Unofficial INACTIVE experimental DX12 scaffold attached; no shader replacements registered.");
