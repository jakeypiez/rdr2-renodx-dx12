/*
 * DX12 replacement for shader 0x2E866023 (ps_5_1) -- RDR2 HDR output / PQ encode pass.
 *
 * Generated by tools/output-port.mjs from a 3DMigoto decompilation of the game's
 * own DX12 bytecode (captures/msasm/0x2E866023.ps_5_1.asm), so the resource
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.xyzw = v2.xyzw * cb22[8].xyzw + cb22[7].xyzw;
  r1.x = t32.Sample(s5_s, v1.xy).w;
  r0.w = r1.x * r0.w;
  if (cb22[10].x != 0) {
