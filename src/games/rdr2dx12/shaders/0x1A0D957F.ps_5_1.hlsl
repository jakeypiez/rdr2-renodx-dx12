/*
 * DX12 replacement for shader 0x1A0D957F (ps_5_1) -- RDR2 HDR output / PQ encode pass.
 *
 * Generated by tools/output-port.mjs from a 3DMigoto decompilation of the game's
 * own DX12 bytecode (captures/msasm/0x1A0D957F.ps_5_1.asm), so the resource
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.xyzw = cb22[6].xyzw * cb22[8].xyzw + cb22[7].xyzw;
  if (cb22[10].x != 0) {
